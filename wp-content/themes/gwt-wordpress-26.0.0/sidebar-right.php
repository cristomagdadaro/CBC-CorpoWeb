...
<aside id="sidebar-right" class="relative <?php govph_displayoptions( 'govph_sidebar_position_right' ); ?>columns"
    role="complementary">
    <?php if ( is_front_page() ) : ?>
        <h2 class="text-lg sm:text-xl text-white p-2 md:text-2xl bg-gradient-to-r from-[#a2b917] to-[#1f5d2b] lg:text-3xl text-center"><strong>Center Chief</strong></h2>
       <aside id="block-165" class="widget callout border-none secondary widget_block reveal-on-scroll-500">
            <div class="flex-col items-center gap-3 hidden lg:flex md:flex">
