 ...
 */
?>
<form role="search" method="get" class="search-form flex items-center bg-white rounded-full overflow-hidden w-full active:border-green-600 focus:border-green-600 shadow-lg" action="<?php echo esc_url( home_url( '/' ) ); ?>">
