...
<head>
    ...
    <style id="preloader-critical-css">
        ...
        #preloader.preloader-started .preloader-logo {
            animation: cbc-preloader-logo-reveal 0.8s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards,
...
<div id="accessibility-shortcuts">
    <ul>
        ...
        <?php if ( $govph_acc_link_main_content = govph_displayoptions( 'govph_acc_link_main_content' ) ): ?>
            <li><a href="<?php echo esc_url( $govph_acc_link_main_content ); ?>" accesskey="R">Skip to Main Content</a>
            </li>
        <?php endif; ?>
        ...
        <header id="site-header" class="<?php echo esc_attr( $site_header_classes ); ?>">
            <div id="site-header-bar" class="site-header-bar bg-transparent transition-all duration-500">
                <div class="site-header__chrome relative isolate">
                    <div id="header-gradient-bg" class="absolute inset-0 z-0 w-full"
                         style="background: linear-gradient(90deg, #1f5d2b 0%, #55A147 50%, #a2b917 100%); -webkit-mask-image: linear-gradient(to bottom, black 50%, transparent 100%); mask-image: linear-gradient(to bottom, black 10%, transparent 100%);"></div>
                            ...
                            <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:gap-4 xl:gap-6">
                                ...
                                <div class="site-header__meta-stack flex flex-col items-end gap-2 text-right">
                                    ...
                                    <div id="pst-container"
                                         class="site-header__time text-xs font-medium tracking-[0.2em] uppercase"
                                         style="display: none; font-size: 0.7rem !important;">
                        ...
                        <div class="site-header__desktop-nav hidden items-center justify-between gap-6 transition-all duration-500 lg:flex z-10">
                            <div class="flex min-w-0 flex-1 items-center gap-4 xl:gap-6">
                                <?php if ( has_nav_menu( 'topbar_left' ) ) : ?>
                                    <nav class="gwt-desktop-nav gwt-desktop-nav--primary min-w-0 flex-1"
                                         aria-label="Primary navigation">
                                        <ul class="dropdown menu flex flex-wrap items-center gap-1 !my-0"
                                            data-dropdown-menu>
                                            <?php
                                            wp_nav_menu(
                                                    array(
                                ...
                                <?php if ( has_nav_menu( 'aux_nav' ) ) : ?>
                                    <nav class="gwt-desktop-nav gwt-desktop-nav--aux min-w-0"
                            ...
                            <?php if ( has_nav_menu( 'topbar_right' ) ) : ?>
                                <nav class="gwt-desktop-nav gwt-desktop-nav--utility shrink-0"
                                     aria-label="Contact navigation">
                                    <ul class="dropdown menu flex flex-wrap items-center justify-end gap-1 !my-0"
                                        data-dropdown-menu>
                                        <?php
                                        wp_nav_menu(
                                                array(
            ...
            <div id="site-mobile-menu-panel"
                 class="site-mobile-menu-panel overflow-hidden transition-[max-height,opacity] duration-300 ease-in-out lg:hidden"
                 style="max-height: 0; opacity: 0; pointer-events: none;"
                 aria-hidden="true">
                <div class="mx-auto w-full max-w-[1280px] px-3 pb-5 pt-3 sm:px-5">

                    <?php if ( $has_header_search ) : ?>
                        <div class="mb-3 flex items-center gap-2 rounded-xl bg-slate-100 px-3 py-2">
                            <svg class="h-4 w-4 shrink-0 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                            <?php get_search_form(); ?>
                        </div>
                    <?php endif; ?>
