...
<?php
  ...
  public function register_settings_fields()
  {
    ...
    add_settings_field('govph_enable_widget_classic_editor', 'Enable Classic Editor on Widgets', array($this, 'govph_enable_widget_classic_editor'), __FILE__, 'govph_main_section');
    add_settings_field('govph_enable_post_classic_editor', 'Enable Classic Editor on Posts', array($this, 'govph_enable_post_classic_editor'), __FILE__, 'govph_main_section');
    ...
    add_settings_field('govph_logo', 'Website Logo', array($this, 'govph_logo_setting'), __FILE__, 'govph_main_section');
    ...
    add_settings_field('govph_background_header_size', 'Header Background Image Fullwidth', array($this, 'govph_background_header_size_fullwith_setting'), __FILE__, 'govph_main_section');
...
if (!function_exists('govph_sanitize_options')) {
    function govph_sanitize_options( $input ) {
        ...
        $url_fields = array(
            'govph_logo','govph_headerimage','govph_sliderimage',
            'govph_acc_link_home','govph_acc_link_contact','govph_acc_link_feedback',
            'govph_acc_link_faq','govph_acc_link_search','govph_acc_link_statement',
        );
        ...
        $text_fields = array(
            'govph_agency_name','govph_agency_tagline',
            'govph_breadcrumbs_separator','govph_content_pub_date_lbl',
            'govph_content_pub_author_lbl',
        );
...
if (!function_exists('govph_displayoptions')) {
	function govph_displayoptions( $options ) {
      ...
      '<a rel="home" href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" id="textlogo-wrapper" class="flex items-center gap-2 w-full justify-center sm:justify-start">
              <div class="gap-1 w-fit flex">
                  <img id="textlogo-image"  draggable="false" loading="eager" decoding="async" alt="Department of Agriculture Official Logo" src="' . $da_logo_render . '" class="h-full md:w-20 w-12 drop-shadow-[0_6px_13px_rgba(255,255,255,0.3)]" />
                  <img id="textlogo-image" draggable="false" loading="eager" decoding="async" alt="' . esc_attr( $option['govph_agency_name'] ) . ' Official Logo" src="' . $agency_logo_render . '" class="h-full md:w-20 w-12 drop-shadow-[0_6px_13px_rgba(255,255,255,0.3)]" /> <!-- Added h-full class -->
              </div>
