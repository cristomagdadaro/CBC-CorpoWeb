...
class GOVPH {
    ...
    private array $_default_options = array(
            'govph_disable_search'                  => '',
            'govph_enable_classic_widgets'          => '',
            'govph_logo_position'                   => 'center',
            'govph_logo'                            => '',
            'govph_logo_enable'                     => '',
            'govph_agency_name'                     => '',
        ...
        // For Approval of menu colors
        // 'govph_custom_menu_color' => '',
        // 'govph_custom_menu_font_color' => '',
    ...
    public static function add_menu_page() {
        add_theme_page( 'Theme Options', 'Theme Options', 'administrator', 'govph-options', array(
                'GOVPH',
                'govph_options_page'
        ), 6 );
    }
    ...
    public static function govph_options_page() {
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                ...
                // For Approval of menu colors
                // $('#color-field-menu-bg').iris(colorPickerOption);
                // $('#color-field-menu-font-color').iris(colorPickerOption);
                // $('#color-field-menu-font-color-hover').iris(colorPickerOption);
                // End for Approval of menu colors
    ...
    public function register_settings_fields() {
        ...
        add_settings_field( 'govph_general_section', '<h3>General Options<h3>', array(
                $this,
                'govph_general_section'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_disable_search', 'Search Disabled', array(
                $this,
                'govph_disable_search'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_enable_widget_classic_editor', 'Enable Classic Editor on Widgets', array(
                $this,
                'govph_enable_widget_classic_editor'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_enable_post_classic_editor', 'Enable Classic Editor on Posts', array(
                $this,
                'govph_enable_post_classic_editor'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_logo_enable', 'Enable Image Logo', array(
                $this,
                'govph_logo_enable'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_agency_name', 'Agency Name', array(
                $this,
                'govph_agency_name'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_agency_tagline', 'Agency Tagline', array(
                $this,
                'govph_agency_tagline'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_header_font_color', 'Header Font Color', array(
                $this,
                'govph_header_font_color'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_logo_position', 'Logo Position', array(
                $this,
                'govph_logo_position_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_logo', 'Website Logo', array(
                $this,
                'govph_logo_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_headercolor', 'Header Background Color', array(
                $this,
                'govph_header_color_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_headerimage', 'Header Background Image', array(
                $this,
                'govph_header_image_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_background_header_size', 'Header Background Image Fullwidth', array(
                $this,
                'govph_background_header_size_fullwith_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_slidercolor', 'Slider Background Color', array(
                $this,
                'govph_slider_color_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_sliderimage', 'Slider Background Image', array(
                $this,
                'govph_slider_image_setting'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_slider_fullwidth', 'Slider Full Width', array(
                $this,
                'govph_slider_fullwidth'
        ), __FILE__, 'govph_main_section' );

        // add govph_breadcrumbs separator and option
        add_settings_field( 'govph_breadcrumbs_enable', 'Enable Breadcrumbs', array(
                $this,
                'govph_breadcrumbs_enable'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_breadcrumbs_separator', 'Breadcrumbs Separator', array(
                $this,
                'govph_breadcrumbs_separator'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_breadcrumbs_show_home', 'Breadcrumb Homepage Link', array(
                $this,
                'govph_breadcrumbs_show_home'
        ), __FILE__, 'govph_main_section' );

        // custom styling
        add_settings_field( 'govph_custom_section', '<h3>Theme Styling<h3>', array(
                $this,
                'govph_custom_section'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_pst', 'Philippine Standard Time', array(
                $this,
                'govph_custom_pst'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_anchorcolor', 'Anchor Color Settings', array(
                $this,
                'govph_custom_anchorcolor'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_anchorcolor_hover', 'Anchor Color Settings (Hover)', array(
                $this,
                'govph_custom_anchorcolor_hover'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_panel_top', 'Panel Top Color', array(
                $this,
                'govph_custom_panel_top'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_panel_bottom', 'Panel Bottom Color', array(
                $this,
                'govph_custom_panel_bottom'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_border_width', 'Border Width', array(
                $this,
                'govph_custom_border_width'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_border_radius', 'Border Radius', array(
                $this,
                'govph_custom_border_radius'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_border_color', 'Border Color', array(
                $this,
                'govph_custom_border_color'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_background_color', 'Background Color', array(
                $this,
                'govph_custom_background_color'
        ), __FILE__, 'govph_main_section' );
        // For Approval of menu colors
        // add_settings_field('govph_custom_menu_color', 'Menu Color', array($this, 'govph_custom_menu_color'), __FILE__, 'govph_main_section');
        // add_settings_field('govph_custom_menu_font_color', 'Menu Font Color', array($this, 'govph_custom_menu_font_color'), __FILE__, 'govph_main_section');
        // add_settings_field('govph_custom_menu_font_color_hover', 'Menu Font Color on Hover and Active', array($this, 'govph_custom_menu_font_color_hover'), __FILE__, 'govph_main_section');
        // End Approval of menu colors
        add_settings_field( 'govph_custom_headings_text', 'Header Rendering', array(
                $this,
                'govph_custom_headings_text'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_headings_size', 'Blog Title Header', array(
                $this,
                'govph_custom_headings_size'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_headings_inner_page_size', 'Banner Title Header', array(
                $this,
                'govph_custom_headings_inner_page_size'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_custom_footer_background_color', 'Agency Footer Color', array(
                $this,
                'govph_custom_footer_background_color'
        ), __FILE__, 'govph_main_section' );
        ...
        // announcements & events
        add_settings_field( 'govph_announcements', 'Announcements (manual)', array(
                $this,
                'govph_announcements'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_events', 'Events & Trainings', array(
                $this,
                'govph_events'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_holidays', 'Holidays (Local/International)', array(
                $this,
                'govph_holidays'
        ), __FILE__, 'govph_main_section' );

        // Calendar display mode (grid or list)
        add_settings_field( 'govph_calendar_display', 'Calendar Display Mode', array(
                $this,
                'govph_calendar_display'
        ), __FILE__, 'govph_main_section' );

        // publishing options
        add_settings_field( 'govph_content_section', '<h3>Publishing Options<h3>', array(
                $this,
                'govph_content_section'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_content_show_pub_date', 'Show Published Date', array(
                $this,
                'govph_content_show_pub_date'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_content_pub_date_lbl', 'Publish Date Label', array(
                $this,
                'govph_content_pub_date_lbl'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_content_show_author', 'Show Publisher', array(
                $this,
                'govph_content_show_author'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_content_pub_author_lbl', 'Publish Author Label', array(
                $this,
                'govph_content_pub_author_lbl'
        ), __FILE__, 'govph_main_section' );

        // accessibility links
        add_settings_field( 'govph_acc_link_section', '<h3>Accessibility<h3>', array(
                $this,
                'govph_acc_link_section'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_keys', 'Accessibility Combination Keys', array(
                $this,
                'govph_acc_link_keys'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_statement', 'Accessibility Statement<br/>(Combination + 0)', array(
                $this,
                'govph_acc_link_statement'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_home', 'Home Page<br/>(Combination + H)', array(
                $this,
                'govph_acc_link_home'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_main_content', 'Main Content<br/>(Combination + R)', array(
                $this,
                'govph_acc_link_main_content'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_contact', 'Contact<br/>(Combination + C)', array(
                $this,
                'govph_acc_link_contact'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_feedback', 'Feedback<br/>(Combination + K)', array(
                $this,
                'govph_acc_link_feedback'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_faq', 'FAQ<br/>(Combination + Q)', array(
                $this,
                'govph_acc_link_faq'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_sitemap', 'Site Map<br/>(Combination + M)', array(
                $this,
                'govph_acc_link_sitemap'
        ), __FILE__, 'govph_main_section' );
        add_settings_field( 'govph_acc_link_search', 'Search<br/>(Combination + S)<br/>---Optional---', array(
                $this,
                'govph_acc_link_search'
        ), __FILE__, 'govph_main_section' );
    }
    ...
    public function handle_option_item_delete() {
        ...
        if ( empty( $_GET['govph_del_field'] ) ) {
            return;
        }
        if ( ! isset( $_GET['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'govph_del_item' ) ) {
            return;
        }
    ...
    public function govph_announcements() {
        ...
        <div style="display:flex; gap:20px; align-items:flex-start;">
            <div style="flex:1; min-width:300px;">
                <textarea name="govph_options[govph_announcements]" rows="4" cols="80"
                          style="max-width: 100%; width: 100%;"
                          placeholder="Plain text announcements; optional link after a pipe (|). One per line.&#10;Example: Pest advisory in Region III|https://example.com/advisory"></textarea>
                <br/>
            ...
            <div style="flex:1; min-width:280px;">
                ...
                <ul style="margin-top:8px; max-height:200px; overflow:auto; border:1px solid #ddd; padding:8px; background:#fff;">
                    <?php foreach ( $lines as $idx => $line ): $line = trim( $line );
                        if ( ! $line ) {
                            continue;
                        } ?>
                        <li style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:6px;">
                            ...
                            <a class="button button-small" href="<?php echo esc_url( add_query_arg( array(
                                    'govph_del_field' => 'govph_announcements',
                                    'govph_del_index' => $idx,
                                    'govph_del_value' => rawurlencode( $line ),
                                    '_wpnonce'        => $nonce
                            ), $page_url ) ); ?>" onclick="return confirm('Delete this announcement?');">Delete</a>
                        </li>
                    <?php endforeach; ?>
    ...
    public function govph_events() {
        ...
        <div style="display:flex; gap:20px; align-items:flex-start;">
            <div style="flex:1; min-width:300px;">
                <textarea name="govph_options[govph_events]" rows="8" cols="80" style="max-width: 100%; width: 100%;"
                          placeholder="YYYY-MM-DD|Title|URL(optional)|Type(event/training)|Location(optional)&#10;2025-10-05|Hands-on Training on Tissue Culture|https://example.com/event/123|training|DA-CBC Center&#10;2025-11-12|Field Day: Hybrid Rice Demo|||Nueva Ecija"></textarea>
                <br/>
                ...
                <ul style="margin-top:8px; max-height:200px; overflow:auto; border:1px solid #ddd; padding:8px; background:#fff;">
                    <?php foreach ( $lines as $idx => $line ): $line = trim( $line );
                        ...
                        <li style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:6px;">
                            <span style="word-break:break-all;"><?php echo esc_html( $line ); ?></span>
                            <a class="button button-small" href="<?php echo esc_url( add_query_arg( array(
                                    'govph_del_field' => 'govph_events',
                                    'govph_del_index' => $idx,
                                    'govph_del_value' => rawurlencode( $line ),
                                    '_wpnonce'        => $nonce
                            ), $page_url ) ); ?>" onclick="return confirm('Delete this event?');">Delete</a>
                        </li>
                    <?php endforeach; ?>
                    <?php if ( empty( array_filter( array_map( 'trim', $lines ) ) ) ): ?>
                        <li style="color:#777;">No items saved yet.</li>
    ...
    public function govph_holidays() {
        ...
        <div style="display:flex; gap:20px; align-items:flex-start;">
            <div style="flex:1; min-width:300px;">
                <textarea name="govph_options[govph_holidays]" rows="6" cols="80" style="max-width: 100%; width: 100%;"
                          placeholder="YYYY-MM-DD|Holiday name|Scope(optional e.g., PH/Intl)&#10;2025-11-30|Bonifacio Day|PH&#10;2025-12-25|Christmas Day|Intl"></textarea>
                <br/>
                ...
                <ul style="margin-top:8px; max-height:200px; overflow:auto; border:1px solid #ddd; padding:8px; background:#fff;">
                    <?php foreach ( $lines as $idx => $line ): $line = trim( $line );
                        ...
                        <li style="display:flex; align-items:center; justify-content:space-between; gap:8px; margin-bottom:6px;">
                            <span style="word-break:break-all;"><?php echo esc_html( $line ); ?></span>
                            <a class="button button-small" href="<?php echo esc_url( add_query_arg( array(
                                    'govph_del_field' => 'govph_holidays',
                                    'govph_del_index' => $idx,
                                    'govph_del_value' => rawurlencode( $line ),
                                    '_wpnonce'        => $nonce
                            ), $page_url ) ); ?>" onclick="return confirm('Delete this holiday?');">Delete</a>
                        </li>
                    <?php endforeach; ?>
                    <?php if ( empty( array_filter( array_map( 'trim', $lines ) ) ) ): ?>
                        <li style="color:#777;">No items saved yet.</li>
    ...
    public function govph_calendar_display() {
        ...
        ?>
        <label for="govph_calendar_display_grid"><input type="radio" id="govph_calendar_display_grid"
                                                        name="govph_options[govph_calendar_display]"
                                                        value="grid" <?php echo( $saved === 'grid' ? 'checked' : '' ); ?>>
            Grid (month calendar)</label>
        <br/>
        <label for="govph_calendar_display_list"><input type="radio" id="govph_calendar_display_list"
                                                        name="govph_options[govph_calendar_display]"
                                                        value="list" <?php echo( $saved === 'list' ? 'checked' : '' ); ?>>
            List (cards)</label>
    ...
    public function govph_enable_widget_classic_editor() {
        ...
        ?>
        <input type="checkbox" name="govph_options[govph_enable_widget_classic_editor]"
               value="true" <?php echo $true ?>>
        <span class="description">Check to disabled Gutenberg on widgets</span>
        <?php
    }
    // End for enable classic Editor for widgets
    ...
    public function govph_logo_setting() {
        ...
        <label for="upload_image">
            <input id="upload_image" type="text" size="36" name="govph_options[govph_logo]"
                   value="<?php echo esc_attr( $this->options['govph_logo'] ); ?>"/>
    ...
    public function govph_logo_enable() {
        ...
        <label for="logo_enabled">
            <input type="radio" name="govph_options[govph_logo_enable]" id="govph_logo_enable"
                   value="1" <?php echo $enabled ?>>
            <label for="govph_logo_enable">Enable</label> <br>
            <input type="radio" name="govph_options[govph_logo_enable]" id="govph_logo_disable" value="0"
                    <?php echo $disabled ?>> <label for="govph_logo_disable">Disable</label>
            <br/><span class="description">If enabled, the website name will be hidden and image logo will be shown (if
        exists).</span>
        </label>
        <?php
    }
    ...
    public function govph_agency_name() {
        ...
        ?>
        <input type="text" name="govph_options[govph_agency_name]" value="<?php echo esc_attr( $value ); ?>"
    ...
    public function govph_agency_tagline() {
        ...
        ?>
        <input type="text" name="govph_options[govph_agency_tagline]" value="<?php echo esc_attr( $value ); ?>"
               style="width: 400px;"><br/>
    ...
    public function govph_header_color_setting() {
        ?>
        <input name="govph_options[govph_headercolor]" type="text"
               value="<?php echo esc_attr( $this->options['govph_headercolor'] ); ?>"
    ...
    public function govph_header_font_color() {
        ...
        ?>
        <input name="govph_options[govph_header_font_color]" type="text"
               value="<?php echo esc_attr( $header_font_color ); ?>"
    ...
    public function govph_header_image_setting() {
        ...
        <label for="header_image_background">
            <input id="header_image_background" type="text" size="36" name="govph_options[govph_headerimage]"
                   value="<?php echo esc_attr( $this->options['govph_headerimage'] ); ?>"/>
    ...
    // End for Background Header Image

    public function govph_slider_color_setting() {
        ?>
        <input name="govph_options[govph_slidercolor]" type="text"
               value="<?php echo esc_attr( $this->options['govph_slidercolor'] ); ?>"
    ...
    public function govph_slider_image_setting() {
        ...
        <label for="slider_image_background">
            <input id="slider_image_background" type="text" size="36" name="govph_options[govph_sliderimage]"
                   value="<?php echo esc_attr( $this->options['govph_sliderimage'] ); ?>"/>
        ...
        if ( ! empty( $this->options['govph_sliderimage'] ) ) {
            echo '<br/><img src="' . esc_url( $this->options['govph_sliderimage'] ) . '" height="200px" alt="' . esc_attr( $this->options['govph_agency_name'] ) . '" style="background: #ddd; padding: 10px;">';
        }
    }
    ...
    public function govph_breadcrumbs_separator() {
        ...
        ?>
        <input type="text" name="govph_options[govph_breadcrumbs_separator]" value="<?php echo esc_attr( $value ); ?>">
        <br/>
    ...
    public function govph_custom_pst() {
        ...
        ?>
        <input name="govph_options[govph_custom_pst]" type="text"
               value="<?php echo esc_attr( $this->options['govph_custom_pst'] ); ?>"
    ...
    public function govph_custom_anchorcolor() {
        ...
        <input name="govph_options[govph_custom_anchorcolor]" type="text"
               value="<?php echo esc_attr( $this->options['govph_custom_anchorcolor'] ); ?>" class="my-color-field"
               id="color-field-anchor"
    ...
    public function govph_custom_anchorcolor_hover() {
        ...
        <input name="govph_options[govph_custom_anchorcolor_hover]" type="text"
               value="<?php echo esc_attr( $this->options['govph_custom_anchorcolor_hover'] ); ?>"
    ...
    public function govph_custom_panel_top() {
        ...
        <input name="govph_options[govph_custom_panel_top]" type="text"
               value="<?php echo esc_attr( $this->options['govph_custom_panel_top'] ); ?>" class="my-color-field"
               id="color-field-panel-top"
    ...
    // Insert Code here | Please refer to GWT Wordpress Documentation Sheet
    //   end for custom menu color

    //   Start for custom menu font color
    // Insert Code here | Please refer to GWT Wordpress Documentation Sheet
    //   end for custom menu font color

    //   Start for custom menu font color on hover
    // Insert Code here | Please refer to GWT Wordpress Documentation Sheet
    //   end for custom menu font color on hover
    ...
    public function govph_custom_footer_background_color() {
        ...
        <input name="govph_options[govph_custom_footer_background_color]" type="text"
               value="<?php echo esc_attr( $this->options['govph_custom_footer_background_color'] ); ?>"
               class="my-color-field"
    ...
    public function govph_content_pub_date_lbl() {
        ...
        ?>
        <input type="text" name="govph_options[govph_content_pub_date_lbl]" value="<?php echo esc_attr( $default ); ?>">
        <br/>
    ...
    public function govph_content_pub_author_lbl() {
        ...
        ?>
        <input type="text" name="govph_options[govph_content_pub_author_lbl]"
               value="<?php echo esc_attr( $default ); ?>"><br/>
    ...
    public function govph_acc_link_statement() {
        ...
        <input type="text" name="govph_options[govph_acc_link_statement]" value="<?php echo esc_attr( $value ); ?>">
        <br/>
    ...
    public function govph_acc_link_main_content() {
        ...
        <input type="text" name="govph_options[govph_acc_link_main_content]" value="<?php echo esc_attr( $value ); ?>">
        <br/>
    ...
    public function govph_acc_link_faq() {
        ?>
        <span class="field-prefix"><?php echo get_site_url(); ?>/ </span>
        <input type="text" name="govph_options[govph_acc_link_faq]"
               value="<?php echo esc_attr( $this->options['govph_acc_link_faq'] ); ?>">
        <?php
    }
    ...
    area,
    click "Add
    Block" then select "Browse All" and go to Widgets Section and select "Search" widget. <br/>Set title of the page as
    "Search,"
    and choose "Search Page" on Page Attributes from the Template drop-down menu. Click "Publish."<br/>
...
/**
 * Sanitize callback for govph_options.
 * Runs on every settings save to strip dangerous values.
 */
if ( ! function_exists( 'govph_sanitize_options' ) ) {
    function govph_sanitize_options( $input ) {
        $color_fields = array(
                'govph_headercolor',
                'govph_header_font_color',
                'govph_slidercolor',
        ...
        $int_fields = array( 'govph_custom_border_width', 'govph_custom_border_radius' );
...
if ( ! function_exists( 'govph_options_menu' ) ) {
...
if ( ! function_exists( 'govph_options_init' ) ) {
    ...
    function govph_displayoptions( $options ) {
        ...
        switch ( $options ) {
            ...
            case 'govph_logo_setting':
                $logoSetting = ( ! empty( $option['govph_header_font_color'] ) ? 'color:' . sanitize_hex_color( $option['govph_header_font_color'] ) . ';' : '' );
            ...
            case 'govph_header_setting':
                $headerSetting = ( ! empty( $option['govph_headercolor'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_headercolor'] ) . ';' : '' );
            ...
            case 'govph_slider_setting':
                ...
                $sliderSetting .= ( ! empty( $option['govph_slidercolor'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_slidercolor'] ) . ';' : '' );
            ...
            case 'govph_anchorcolor':
                $anchorColor = ( ! empty( $option['govph_custom_anchorcolor'] ) ? 'color:' . sanitize_hex_color( $option['govph_custom_anchorcolor'] ) . ' !important;' : '' );
                echo $anchorColor;
                break;
            case 'govph_anchorcolor_hover':
                $anchorColor = ( ! empty( $option['govph_custom_anchorcolor_hover'] ) ? 'color:' . sanitize_hex_color( $option['govph_custom_anchorcolor_hover'] ) . ' !important;' : '' );
                echo $anchorColor;
                break;
            case 'govph_disable_search':
                if ( gettype( $option ) == 'array' ) {
                    return array_key_exists( 'govph_disable_search', $option );
                }
                break;
            ...
            case 'govph_enable_widget_classic_editor':
                if ( gettype( $option ) == 'array' ) {
                    return array_key_exists( 'govph_enable_widget_classic_editor', $option );
                }
                break;
            ...
            case 'govph_enable_post_classic_editor':
                if ( gettype( $option ) == 'array' ) {
                    return array_key_exists( 'govph_enable_post_classic_editor', $option );
                }
                break;
            ...
            case 'govph_custom_pst':
                $bg = ( ! empty( $option['govph_custom_pst'] ) ? 'color:' . sanitize_hex_color( $option['govph_custom_pst'] ) . ';' : '' );
                echo $bg;
                break;
            case 'govph_custom_panel_top':
                $bg = ( ! empty( $option['govph_custom_panel_top'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_custom_panel_top'] ) . ';' : '' );
                echo $bg;
                break;
            case 'govph_custom_panel_bottom':
                $bg = ( ! empty( $option['govph_custom_panel_bottom'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_custom_panel_bottom'] ) . ';' : '' );
                echo $bg;
                break;
            case 'govph_widget_setting':
                $widgetSetting = isset( $option['govph_custom_border_width'] ) ? 'border:' . intval( $option['govph_custom_border_width'] ) . 'px solid' : '0';
                $widgetSetting .= ( ! empty( $option['govph_custom_border_color'] ) ? ' ' . sanitize_hex_color( $option['govph_custom_border_color'] ) . ';' : '' );
                $widgetSetting .= isset( $option['govph_custom_border_radius'] ) ? 'border-radius:' . intval( $option['govph_custom_border_radius'] ) . 'px ;' : '0';
                $widgetSetting .= ( ! empty( $option['govph_custom_background_color'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_custom_background_color'] ) . ';' : '' );
                echo $widgetSetting;
                break;
            case 'govph_menu_color_setting':
                $menuSetting = '';
                $menuSetting .= ( ! empty( $option['govph_custom_menu_color'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_custom_menu_color'] ) . ';' : '' );
                echo $menuSetting;
                break;
            case 'govph_menu_font_setting':
                $menuFontSetting = '';
                $menuFontSetting .= ( ! empty( $option['govph_custom_menu_font_color'] ) ? 'color:' . sanitize_hex_color( $option['govph_custom_menu_font_color'] ) . ';' : '' );
                $menuFontSetting .= ( ! empty( $option['govph_custom_menu_font_color'] ) ? 'border-color:' . sanitize_hex_color( $option['govph_custom_menu_font_color'] ) . ' ' . 'transparent;' : '' );
            ...
            case 'govph_menu_font_hover_setting':
                ...
                $menuFontHoverSetting .= ( ! empty( $option['govph_custom_menu_font_color_hover'] ) ? 'color:' . sanitize_hex_color( $option['govph_custom_menu_font_color_hover'] ) . ';' : '' );
            ...
            case 'govph_headings_setting':
                ...
                $transform_val      = ! empty( $option['govph_custom_headings_text'] ) && in_array( $option['govph_custom_headings_text'], $allowed_transforms, true ) ? $option['govph_custom_headings_text'] : '';
                $headings           = $transform_val ? 'text-transform:' . $transform_val . ';' : '';
                $headings           .= ( ! empty( $option['govph_custom_headings_size'] ) ? 'font-size:' . floatval( $option['govph_custom_headings_size'] ) . 'em;' : '' );
                echo $headings;
                break;
            case 'govph_inner_headings_setting':
                $allowed_transforms = array( 'none', 'capitalize', 'uppercase', 'lowercase' );
                $size               = ( ! empty( $option['govph_custom_headings_inner_page_size'] ) ? 'font-size:' . floatval( $option['govph_custom_headings_inner_page_size'] ) . 'em;' : '' );
                $transform_val      = ! empty( $option['govph_custom_headings_text'] ) && in_array( $option['govph_custom_headings_text'], $allowed_transforms, true ) ? $option['govph_custom_headings_text'] : '';
                $size               .= $transform_val ? 'text-transform:' . $transform_val . ';' : '';
                echo $size;
                break;
            case 'govph_custom_footer_background_color':
                $bg = ( ! empty( $option['govph_custom_footer_background_color'] ) ? 'background-color:' . sanitize_hex_color( $option['govph_custom_footer_background_color'] ) . ';' : '' );
                echo $bg;
                break;
...
if ( ! function_exists( 'govph_section_header' ) ) {
    ...
    function govph_section_header( $title, $args = [] ) {
        ...
        $align       = in_array( $args['text_alignment'], [
                'left',
                'center',
                'right'
        ], true ) ? $args['text_alignment'] : 'center';
