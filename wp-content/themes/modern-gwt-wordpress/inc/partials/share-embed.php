...
?>
<div class="gwt-share-btns-container text-gray-900" data-post-id="<?php echo esc_attr( $post->ID ); ?>">
  <div class="gwt-share-buttons drop-shadow-md flex items-center w-full p-2 md:p-3" role="group" aria-label="Share">
    <p class="flex items-center whitespace-nowrap m-0">Share via </p>
